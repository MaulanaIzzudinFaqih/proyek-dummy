        ...
        <> 
            ...
            <main className={styles.main}>
                ...
                <div className={styles.tombolkalkulator}>
                    <a href="#Kalkulator pertama"><button> Kalkulator 1</button> </a>
                    <a href="#Kalkulator kedua"><button>Kalkulator 2</button></a>
                </div>
               <br></br>
               <br></br>
               <div className={styles.kalkulatorpertama}
                 id="Kalkulator pertama">
                    <h2>Kalkulator Pertama</h2>
               </div>
               <div className={styles.pkalkulatorsatu}>  
                        <button onClick={() => {setOperation('+')}}>Pertambahan</button>
                        <button onClick={() => {setOperation('-')}}>Pengurangan</button>
                        <button onClick={() => {setOperation('/')}}>Pembagian</button>
                        <button onClick={() => {setOperation("*")}}>Perkalian</button>
                </div>
                ...
                <br></br>
                <br></br>
               <div className={styles.kalkulatorkedua}
                 id="Kalkulator kedua">
